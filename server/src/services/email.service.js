...
// const BASE_URL = (process.env.PUBLIC_BASE_URL || "http://localhost:5000").replace(
//   /\/+$/,
//   ""
// );
...
//   return normalizeEmails(process.env.ADMIN_EMAILS || process.env.ADMIN_COUNSELOR_EMAILS || "");
// }
...
//     : "📄 Download your Pending PDF";

//   const html = `
//     <div style="font-family:system-ui,Arial,sans-serif">
//       <h2 style="color:${isApproved ? "#16a34a" : "#2563eb"};">AWDIZ – Admission ${
...
//  *    — NO Approve button/link here —
//  *
//  * ✅ UPDATED (Key-based routing):
//  * - Supports `counselorKey` from payload (counselor1 / counselor2)
//  * - Supports `to` and `bcc` override (arrays or comma strings)
//  * - Fallback order:
//  *    1) explicit `to`
//  *    2) counselorKey mapping env
//  *    3) COUNSELOR_EMAIL
//  *    4) ADMISSIONS_EMAIL
//  *
//  * ✅ Admin BCC:
//  * - Uses explicit `bcc` if passed
//  * - Else ADMIN_EMAILS/ADMIN_COUNSELOR_EMAILS
//  * ============================================================ */
...
//   const counselorKey = payload?.counselorKey || payload?.meta?.counselorKey || payload?.personal?.counselorKey;
...
//   const finalTo =
//     explicitTo.length ? explicitTo : routedTo.length ? routedTo : legacyTo.length ? legacyTo : officeTo;
...
//   // Admin BCC: explicit bcc -> ADMIN_EMAILS -> none
//   const explicitBcc = normalizeEmails(bcc);
//   const adminBcc = getAdminEmails();

//   const finalBcc = explicitBcc.length ? explicitBcc : adminBcc;
