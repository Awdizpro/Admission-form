//this is my main working code (15/12/2025)
...
//   const t = normalizeSheetTitle(name).replace(/'/g, "''"); // escape single quote in title
//   return `'${t}'`;
// }
...
//   // Body: single-line (CLIP) + top align
//   requests.push({
//     repeatCell: {
//       range: {
//         sheetId,
...
//   // Optional: timestamp formatting (column A)
//   requests.push({
//     repeatCell: {
//       range: {
//         sheetId,
...
// // Write header if missing, then apply neat layout + autoresize
...
// async function ensureStatusConditionalFormatting(sheets, spreadsheetId, sheetName) {
//   const title = normalizeSheetTitle(sheetName);
//   const meta = await sheets.spreadsheets.get({ spreadsheetId });
...
//   // try deleting first few rules safely
//   for (let i = 0; i < 5; i++) {
//     try {
//       await sheets.spreadsheets.batchUpdate({
//         spreadsheetId,
...
// // ✅ Common function to prepare row values
...
//   // ✅ counselorKey store (helps auditing in master)
...
//   if (!spreadsheetId) return; // safe skip if not configured
...
// /* ============================== PUBLIC ============================== */
// /**
//  * Append one admission row to:
//  * 1) Center Sheet → Course Tab
//  * 2) Master Sheet → Center Master Tab
//  * 3) Counselor Spreadsheet (C1/C2) → Course Tab
//  * 4) Master Sheet → Counselor 1 Sheet / Counselor 2 Sheet
//  * 5) Master Sheet → All Admissions
//  */
...
// /**
//  * Flip a row by AdmissionID to Approved/Pending + optionally update Approved PDF URL.
//  * Updates:
//  * - Center Sheet
//  * - Master Center Tab
//  * - Counselor Spreadsheet
//  * - Master Counselor Tab
//  * - Master All Admissions
//  */
...
//   // 3/4/5) counselor updates
//   const counselorKey = counselorKeyFromData(extra) || "c1";
//   const counselorSpreadsheetId = counselorSpreadsheetIdForKey(counselorKey);
//   const masterCounselorTab = counselorMasterTabForKey(counselorKey);

//   const counselorUpdated = counselorSpreadsheetId
...
//   await updateRowInternal(sheets, masterSpreadsheetId, MASTER_TAB_ALL_ADMISSIONS, courseName, data);
// }
