...
router.post("/:id/request-edit", express.urlencoded({ extended: true }), requestEditAdmission);
router.post("/:id/request-edit-counselor", express.urlencoded({ extended: true }), requestEditToCounselor);

router.post("/:id/submit-to-admin", express.urlencoded({ extended: true }), submitToAdmin);

router.post("/:id/approve", express.urlencoded({ extended: true }), approveAdmission);
